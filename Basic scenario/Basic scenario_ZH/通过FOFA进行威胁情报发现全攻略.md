...
![73702317338](通过FOFA进行威胁情报发现全攻略.assets/1737023173385.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/b08e77b7-09b8-4d13-940c-a76fc9321123-1737021963148.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/2319a1ba-7ec3-4d31-9f8c-7c0b6d378fdd-1737021969347.png) 
...
![image](通过FOFA进行威胁情报发现全攻略.assets/55df01da-ae00-46c3-82c9-b398b741659e-1737021974512.png)
...
![image](通过FOFA进行威胁情报发现全攻略.assets/0937ea3c-97b1-4b71-95ff-41cba363a94e-1737021985336.png)

安全星图平台 https://ti.dbappsecurity.com.cn/apt/list

![image](通过FOFA进行威胁情报发现全攻略.assets/86ff206d-5b31-46ed-8cab-79b17a9c5042-1737021989335.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/835e0e98-9946-4d65-a3b6-149c318d80fc-1737021993561.png)
...
![image](通过FOFA进行威胁情报发现全攻略.assets/a73ea2d1-8a1f-48be-ae1a-6559ef7dbea3-1737021998645.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/dbb17d8e-9370-4987-88d4-1facb0f12bd1-1737022002511.png)

![image.png](通过FOFA进行威胁情报发现全攻略.assets/3a41d4ca-b763-4928-bf62-cd8b13387c5b-1737022006264.png)

如：域名为sheicen\[.\]info分别在微步在线情报社区和奇安信威胁情报中心打标签为“Patchwork团伙”，则可以推断该组织为摩诃草组织，又名Patchwork。

![image.png](通过FOFA进行威胁情报发现全攻略.assets/637d2373-5dce-4ac9-b3b4-21651ce27c9a-1737022009162.png)

![image.png](通过FOFA进行威胁情报发现全攻略.assets/46bfe898-6a2b-49c8-ac18-14dee1322088-1737022013332.png)

除此之外，还有以下的情况：域名neger\[.\]site只在微步在线情报社区有打"响尾蛇组织"标签，域名mofagov\[.\]live只在奇安信威胁情报中心打"响尾蛇组织"标签，是由于各平台的属性不同，我们需要在多个威胁情报平台交叉验证，来确定组织。

![image.png](通过FOFA进行威胁情报发现全攻略.assets/eecbc20a-74df-45b8-947d-f76255f81bc6-1737022016318.png)

![image.png](通过FOFA进行威胁情报发现全攻略.assets/d4ba91d5-930c-4474-84f5-88c2cd3bc033-1737022019734.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/c33d98c7-e796-412e-bb39-6746f8fbf67a-1737022023849.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/6d8550c2-a7e6-4707-843f-bb35db7d7dd2-1737022027195.png)

![image](通过FOFA进行威胁情报发现全攻略.assets/9d0e2450-bae7-4536-a23f-79d9a404cbce-1737022031092.png)
...
![image](通过FOFA进行威胁情报发现全攻略.assets/8ffd8f9a-1797-44c0-891d-d132d5e7f687-1737022044789.png)
...
![1735206619359.png](通过FOFA进行威胁情报发现全攻略.assets/f5b03789-ddad-4a5a-9a5c-25e1ca4acea3-1737022148284.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/84540997-9f87-4a0d-96d4-3d18baf652b7-1737022158472.png)

通过此特征最终拓线该组织6条独立IP和多个关联域名。

![image.png](通过FOFA进行威胁情报发现全攻略.assets/91160b79-0c70-4d61-8bc1-1a3d9b67594b-1737022159796.png)

### 基于TLS指纹关联

![4c82333898c1552e368ff35be6b0cac3.png](通过FOFA进行威胁情报发现全攻略.assets/285195f3-05a5-400d-ade4-d24b090ba5a5-1737022166932.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/6e272bce-5d33-402c-a3b4-afacbf2a8155-1737022170171.png)

其中使用cobalt-strike-c2的jarm指纹在FOFA搜索结果如下，显然数据量并不正常。

![image.png](通过FOFA进行威胁情报发现全攻略.assets/66b6e329-c8f9-4c2d-a25b-dd5dc597d853-1737022174478.png)

这里还可以通过对app="COBALTSTRIKE-团队服务器"搜索结果的JARM反向搜索：

![96b8b849-62c0-4b39-b39b-5da6ac95f9f0.png](通过FOFA进行威胁情报发现全攻略.assets/6e677858-4a2d-4136-b630-d3b76fc84d82-1737022177498.png)

![image.png](通过FOFA进行威胁情报发现全攻略.assets/8c8a265a-686a-4c21-bd8f-f0545cc94b01-1737022180881.png)
...
![1734946631611.png](通过FOFA进行威胁情报发现全攻略.assets/afe97fa2-0bb2-4c48-b537-7de10e3e6901-1737022184274.png)
...
![GbjthvOWwAEQsYL.png](通过FOFA进行威胁情报发现全攻略.assets/4544c729-cf46-4ed1-a59f-20c41fc01c0c-1737022199497.png)拓线结果为33个该模板类型的独立ip。

### 基于Banner的指纹关联

![8d6dda1a1803b2b4cadcaca67ed7af1a.png](通过FOFA进行威胁情报发现全攻略.assets/a2d7bfbe-29c4-414f-bc72-8c395217ec12-1737022203755.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/05710025-e154-480f-9714-b8d7070689bf-1737022208515.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/8dc2f8a0-9fe8-4512-9613-e868ac950212-1737022217494.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/76d31a0b-fcf5-45f3-9e94-babedb17f3f2-1737022224714.png)

![image.png](通过FOFA进行威胁情报发现全攻略.assets/06e572d7-758a-4229-bd7a-91c86a816145-1737022232761.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/0ab1e04e-d6c2-4566-a438-f53f3417fdf5-1737022239703.png)

# 误报处理

根据上述拓线后的结果进行误报判断，如果出现符合以下误报情况，则进行去除误报步骤，去除误报完毕，再对现在拓线结果进行再次的误报判断，反复此过程，直到排除所有可判断的误报，输出最后的拓线结果。误报处理流程如下图：

![image.png](通过FOFA进行威胁情报发现全攻略.assets/7ef728c7-792f-4d6d-a62b-718cc9307e8e-1737022245071.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/acaa12cd-8e5e-42ec-9665-5560243b3ec5-1737022248425.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/a87b0cbc-e8d6-4c72-b0e9-75070fff2acf-1737022252540.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/ba0e5f68-c2a0-46c9-b21c-3eddf18eaea3-1737022256708.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/be1e6de1-1a52-4171-b14b-4ec87eab1d03-1737022261651.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/92843b90-bd72-4361-aafe-ef85e85e5e29-1737022264793.png)

线索二：通过证书查找，我们发现证书的 Organization:Internet Widgits Pty Ltd 应该是配置证书时的默认值。分析发现了一个较为关键的线索就是证书有效期。我们通过证书有效期跟证书默认组织名进行搜索。

![image.png](通过FOFA进行威胁情报发现全攻略.assets/c48e59c4-20ef-4f9b-be79-ae2c016445fa-1737022268360.png)

```brainfuck
cert="Internet Widgits Pty Ltd" && cert="2023-06-23 15:59 UTC"
```

![coldriver6.png](通过FOFA进行威胁情报发现全攻略.assets/172acf79-b789-4659-a3e0-51d816690f27-1737022272143.png)
...
![coldriver7.png](通过FOFA进行威胁情报发现全攻略.assets/eb7b2444-d1af-4a14-ba20-1ead4a2e829c-1737022275598.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/28185971-04e0-40c9-bb8e-0d1b67389234-1737022283949.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/8b1216ef-da64-4097-bbcf-fdab186f096b-1737022292764.png)
...
![image.png](通过FOFA进行威胁情报发现全攻略.assets/b00c54de-5524-450e-90db-fb4895ad83ac-1737022294960.png)

### 其他情况

有这样一个场景，通过分析IOC发现目标域名全部是https://xxx.com 且无子域名，这种情况下仅依赖FOFA语法已无法实现需求所以需要对结果进行二次筛选。类似的情况在实际分析中一定还会遇到，所以需要具体情况具体分析。
