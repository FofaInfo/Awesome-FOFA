...
![lQLPJv8zNjAYBX_NArHNBQCwX3hUCxLxUyoHmeComQLNAA_1280_689.png](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/b504219d-71d6-41d5-9e84-0aeb2cbf533e.png)
...
![图片 2](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/fadb2da3-9793-45b3-8103-638a0c074c16.png)

## 应用分布

从FOFA匹配的结果中，除了官方资产信息，相关的资产主要分布在6个类：本地搭建与客户端类906个，内容资讯类771个，域名注册商类232个，论坛类152个，虚拟货币相关类62个，仿冒与钓鱼网站类38个。

![图片 3](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/d2744e9b-e9e4-4507-8d43-2b5c4526060b.png)
...
![图片 4](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/1a542418-d7c5-48c9-95a5-4cd6ea4db262.png)

Ollama搜索结果

如图，某近千用户的AI运营平台可以使用默认管理账户随意进入，价格设定、公告通知可被随意篡改，服务日志存在大量用户数据被泄露。默认配置问题正在成为当前DeepSeek本地部署与客户端类应用的首要威胁。

![图片 2](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/39e7a248-8c2a-4a94-a0a9-6f7a2e4206d5.png)
...
![图片 2](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/d6232ba2-5696-4ddc-822c-b3dce6745337.png)

beian.miit.gov.cn

仿冒网站，顾名思义，首先要仿，既然仿那么网站的内部信息就是其最有可能被模仿甚至直接使用的对象。通过目标网站我们可以提取出多维度信息。

![图片 3](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/2f11fe2d-19da-4981-9758-3e2f4ced0c14.png)
...
![图片 2](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/61775e8f-e018-4fae-8018-0bd95f0a3b30.png)
...
![图片 4](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/657c3a6f-a066-4ccf-9556-487e8f3f9e5f.png)
...
![图片 5](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/e1a5191a-d12c-4e7c-a3db-3c3e2816abbc.png)

可以看到匹配结果降到了27条，选择判定目标deepseek-v3.live。

![图片 6](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/59f553ed-4d24-48a5-b524-fb4de3bf2889.png)
...
![图片 7](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/86d36457-ecc4-4bef-ab11-76de46b0519c.png)
...
![图片 8](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/6d7b3140-b253-48c4-a5ba-85434c0a51da.png)

这里以chatbot-deepseek.com为例，该网站通过模仿DeepSeek首页将登录选项替换成文件下载。解压后存在恶意文件。

![图片 2](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/ad4a17c8-8190-40fb-9f80-c91393b459f2.png)

chatbot-deepseek.com

![图片 3](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/4fc22908-a14b-4724-9495-cfd7e87dbeba.png)

压缩包内容

另一例替换页面元素为下载可执行文件的恶意网站，发现其在后续执行中从github下载恶意程序：

![图片 1](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/a37bf1ae-5262-4cbd-b19f-77f04b1e3262.png)

home-deepseek.com

![图片 2](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/72c97eee-b402-40e6-bd6c-38ab24c83033.png)
...
![图片 9](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/4faf22bd-ac75-4883-84fb-f0ab3663a4ac.png)
...
![图片 10](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/aff18823-9096-4902-94a2-e166315719ae.png)

以deepseekllm.pro为例，目标以DeepSeek官方的名义发行虚拟货币，其性质明显具有诈骗意味。

![图片 4](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/5987d4d1-7379-409d-8a27-b73c50271b42.png)

deepseekllm.pro

![图片 5](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/c642391d-7384-435f-ba78-d3be48eb8b66.png)
...
![图片 11](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/aa4f0938-1226-4d31-8a75-5e18afd4fdbe.png)

#### download.deepseek.com

该页面是deepseek的下载导航站。

![图片 12](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/565c4b37-b568-4020-a992-eee08bc4f316.png)
...
![图片 13](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/57f05330-f2e3-4789-98ed-7b59778f8728.png)
...
![图片 14](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/e43fde23-dcb0-4910-967f-29cf932d6c30.png)
...
![图片 16](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/1737547d-5ab7-475e-a8ed-64dbc2643439.png)
...
![图片 7](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/4296a5f1-c46c-48f4-ab72-943889b937f0.png)
...
![图片 8](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/382029e6-9395-486c-a135-1820b90aff25.png)

通过fofa的聚合面板进一步的筛选，浏览title内容快速判断是否可能为仿冒，然后点击访问进一步判断。

![图片 21](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/2ea6bdcf-9fed-465d-b7de-20a8af15c82b.png)
...
![图片 8](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/553f1573-d6d5-4399-be33-20bfeae6fdf2.png)
...
![图片 1](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/8a71f24d-4ca0-429e-82a9-80ee72b83d7e.png)

搜索当前目标时可以看到大量与DeepSeek图标相似的ICON，这时我们可以选择相似的图标进行批量搜索。在搜索结果中可以发现之前得到的deepseek-v3\[.\]live正在其中。

![图片 2](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/40c9a120-0059-4632-b481-ae8d85e6c5b6.png)
...
![图片 1](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/2c23edb8-ddaf-4326-9592-88374760ce65.png)

43个结果的Cloud聚合统计

我们通过同样的方式对官方资产进行Cloud聚合：

![图片 29](https://github.com/FofaInfo/Awesome-FOFA/blob/main/Storage/deepseek/23dc46c9-a901-4fc4-a714-9e6457897176.png)
